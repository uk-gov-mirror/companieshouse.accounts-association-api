...
2. Execute the following in the docker-chs-development directory:
  - `chs-dev services enable accounts-association-api`
  - `chs-dev development enable accounts-association-api`
