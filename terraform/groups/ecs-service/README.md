...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ecs-service"></a> [ecs-service](#module\_ecs-service) | git@github.com:companieshouse/terraform-modules//aws/ecs/ecs-service | 1.0.369 |
| <a name="module_secrets"></a> [secrets](#module\_secrets) | git@github.com:companieshouse/terraform-modules//aws/ecs/secrets | 1.0.326 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_accounts_association_api_version"></a> [accounts\_association\_api\_version](#input\_accounts\_association\_api\_version) | The version of the accounts-association-api container to run. | `string` | n/a | yes |
