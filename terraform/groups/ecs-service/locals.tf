...
locals {
  ...
  lb_listener_paths          = ["/associations-api/healthcheck*", "/associations","/associations?*", "/associations/companies/*"]
  healthcheck_path           = "/associations-api/healthcheck" #healthcheck path for accounts association service
